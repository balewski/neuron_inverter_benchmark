...
echo "ENERGY_LOG,date,unix_millisec,hostname,node_governor,node_ene_J,cpu_ene_J,memory_ene_J,gpu0_ene_J,gpu1_ene_J,gpu2_ene_J,gpu3_ene_J,freshness,jobId"
