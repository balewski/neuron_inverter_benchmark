...
def get_parser():
    ...
    parser.add_argument("-j", "--jobId",default='G32scan',  help=" job ID")
    parser.add_argument("-t","--tag",default='lr.002',  help=" extra string in the path")
    ...
    args.prjName='eneUse'
    args.sourcePath='/global/homes/b/balewski/prjs/SC2022-neuron-inverter/ref-jobs-for-GC/april_GCpaper'
...
#...!...!....................
def ana_one_job(jobId,table,args):
...
if __name__ == '__main__':
    ...
    stockD={}
    jobId=args.jobId
    inpF=os.path.join(args.sourcePath,jobId,args.tag,'log.energy.csv')
    table,label=read_one_csv(inpF)
    metaD,bigD=ana_one_job(jobId,table,args)
